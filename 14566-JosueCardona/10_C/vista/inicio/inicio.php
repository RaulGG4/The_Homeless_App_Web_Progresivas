...
<head>
    ...
    <link rel="stylesheet" href="configuraciones/css/bootstrap.css">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Ingrese Correo" id="user">
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="ingrese correo " id="admin">
                    </div>
                    <div class="form-group">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                <button type="submit" onclick="login_admin()" class="btn btn-primary">Ingresar</button>
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                </div>
...
-->
    ...
    <script src="configuraciones/js/login/login_admin.js"></script>
